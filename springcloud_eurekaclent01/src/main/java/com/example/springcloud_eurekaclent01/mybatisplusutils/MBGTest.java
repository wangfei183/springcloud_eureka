package com.example.springcloud_eurekaclent01.mybatisplusutils;
...
//                .setOutputDir("C:\\Users\\EDZ\\Desktop\\生成代码文件") // 生成路径(绝对路径)
        ...
        source.setDbType(DbType.MYSQL)					// 设置数据库类型
                ...
                .setUrl("jdbc:mysql://localhost:3306/wf_book?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=Hongkong")	// 数据库地址
...
//                .setTablePrefix("tbl_")				// 表前缀
                .setInclude("cloud_grade"); 		// 生成的表

        // 包名配置
        PackageConfig packageConfig = new PackageConfig();
        packageConfig.setParent("com.example.springcloud_eurekaclent01") 	// 所有包的父包
                .setEntity("bean")				// 实体类包
